...
public class Example9B extends JFrame implements ListSelectionListener, ActionListener {
	...
	public Example9B() {
		...
		myList = new JList();
		ListModel model = new Example9BListModel();
	...
	public static void main(String[] args) {
		Example9B window = new Example9B();
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (value != null) {
			((Example9BListModel) myList.getModel()).addData(value);
		} else {
			((Example9BListModel) myList.getModel()).removeData(0);
		}
	}
